...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden relative">
      ...
      <div className="fixed inset-0 bg-gradient-to-br from-green-700/20 via-teal-800/20 to-sky-900/20 animate-pulse"></div>
      ...
      <footer className="relative z-10 border-t py-8 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto text-center">
          <p className="text-muted-foreground">
            Made with ❤️ by{" "}
            <span className="text-foreground font-semibold">Arvind Rana</span>
          </p>
        </div>
      </footer>
    </div>
